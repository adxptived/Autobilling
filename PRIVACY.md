...
The extension stores the following data in `chrome.storage.local` / browser local extension storage:
...
- UI preferences, such as compact view and BIN validation toggle

This data stays on your device and is not sent to the author.
